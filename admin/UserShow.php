...
<div class="container-fluid" style="margin-top:40px ;">
    <div class="row justify-content-around" >
        ...
        <div class="row justify-content-center">
                    ...
                    <div class="col-sm-12">
                        <center> <h1> EMPLOYEE'S </h1></center>
                        </div>
                        </div>
                    <div class="row justify-content-end">
                        <div class="col-sm-3 text-end"> 
                            <a href="UserAdd.php" class="btn btn-primary w-100 my-3"> ADD EMPLOYEE </a> 
                        </div>
                        </div>  
                        ...
                        <thead class="" style="color:white; background-color: #100e0e; text-align: center;">
                          ...
                          <tbody style="text-align:center;">
                            ...
                            <tr>
                              ...
                              <td><?php echo $row['phone']." / ".$row['alt_phone']; ?></td>
                              <td><?php echo $row['email']; ?></td>
                              <td><?php echo $row['ac_no']; ?></td>
                              <td><?php echo $row['address']; ?></td>
                              <td><i class="fa-solid fa-trash mr-4"></i> &#160; &#160;&#160; <i class="fa-solid fa-pen-to-square ml-4"></i></td>
                            </tr>
                            <?php
                                   }
                               }
