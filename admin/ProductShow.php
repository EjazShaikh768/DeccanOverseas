                          ...
                          <tbody style="">
                           ...
                           $result = mysqli_query($conn , $sql) or die("query unsuccesfull");
                            ...
                            <tr>
                              ...
                              <td><img  src="upload/<?php echo $row['product_image']; ?>" height="100px" width="150px"></td>
                              <td><?php echo $row['product_category']; ?></td>
                              <td><?php echo $row['product_description']; ?></td>
                              <td> <a href="productDlt.php?Pid=<?php echo $row['prod_id'];?>"><i class="fa-solid fa-trash mr-4"></i></a> &#160; &#160;&#160;
